    ...
    <div className="space-y-6 max-w-4xl mx-auto">
      ...
      <Tabs defaultValue="csv" className="w-full">
        ...
        <TabsContent value="csv" className="space-y-4 mt-6">
          <CSVExcelUpload onTransactionsParsed={handleCSVParsed} />
          ...
          <div className="glass-card p-6 space-y-4">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  AI analyzes descriptions to categorize transactions
                </p>
              </div>

              <div>
                <h4 className="font-medium mb-1 flex items-center gap-2">
                  <span className="text-primary">•</span> Error Detection
                </h4>
                <p className="text-sm text-muted-foreground">
                  Identifies and reports invalid rows with clear messages
                </p>
              </div>

              <div>
                <h4 className="font-medium mb-1 flex items-center gap-2">
                  <span className="text-primary">•</span> Server Processing
                </h4>
                <p className="text-sm text-muted-foreground">
                  Secure server-side parsing for reliability
                </p>
              </div>
            </div>
          </div>
