...
CREATE INDEX idx_mfa_credentials_user_id ON public.mfa_credentials(user_id);
...
CREATE INDEX idx_security_alerts_acknowledged ON public.security_alerts(acknowledged) WHERE NOT acknowledged;